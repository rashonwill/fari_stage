...
CREATE INDEX idx_videotitle ON channel_uploads(videotags);
...
CREATE TABLE vendors (
  ...
  FOREIGN KEY(vendorname) REFERENCES users(username) ON DELETE CASCADE ON UPDATE CASCADE,
...
vendorname varchar(255),
FOREIGN KEY(vendorname) REFERENCES users(username) ON UPDATE CASCADE ON DELETE CASCADE,
...
FOREIGN KEY(user1_username) REFERENCES users(username) ON UPDATE CASCADE ON DELETE CASCADE,
user1_pic TEXT,
...
sendername varchar(255),
FOREIGN KEY(sendername) REFERENCES users(username) ON UPDATE CASCADE ON DELETE CASCADE,
receiverid INT,
FOREIGN KEY(receiverid) REFERENCES users(id) ON DELETE CASCADE,
receivername varchar(255),
FOREIGN KEY(receivername) REFERENCES users(username) ON UPDATE CASCADE ON DELETE CASCADE,
...
FOREIGN KEY(videotitle) REFERENCES channel_uploads(videotitle) ON UPDATE CASCADE ON DELETE CASCADE,
...
FOREIGN KEY (channelid) REFERENCES user_channel(id) ON DELETE CASCADE,
channelname varchar(255) NULL,
FOREIGN KEY(channelname) REFERENCES users(username) ON UPDATE CASCADE ON DELETE CASCADE,
